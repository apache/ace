 ...
 */
public class ArtifactToFeatureAssocExtensionFactory extends BaseAssociationExtensionFactory<ArtifactObject, Artifact2FeatureAssociation> {
    ...
    @Override
    protected Stream<Artifact2FeatureAssociation> getAssocations(ArtifactObject artifact) {
