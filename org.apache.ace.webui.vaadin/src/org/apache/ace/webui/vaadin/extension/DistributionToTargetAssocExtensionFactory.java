 ...
 */
public class DistributionToTargetAssocExtensionFactory extends BaseAssociationExtensionFactory<DistributionObject, Distribution2TargetAssociation> {
    ...
    @Override
    protected Stream<Distribution2TargetAssociation> getAssocations(DistributionObject dist) {
