 ...
 */
public class DistributionToFeatureAssocExtensionFactory extends BaseAssociationExtensionFactory<DistributionObject, Feature2DistributionAssociation> {
    ...
    @Override
    protected Stream<Feature2DistributionAssociation> getAssocations(DistributionObject dist) {
