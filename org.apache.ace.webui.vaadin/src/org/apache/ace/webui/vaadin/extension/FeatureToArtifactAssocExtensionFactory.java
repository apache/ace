 ...
 */
public class FeatureToArtifactAssocExtensionFactory extends BaseAssociationExtensionFactory<FeatureObject, Artifact2FeatureAssociation> {
    ...
    @Override
    protected Stream<Artifact2FeatureAssociation> getAssocations(FeatureObject feature) {
