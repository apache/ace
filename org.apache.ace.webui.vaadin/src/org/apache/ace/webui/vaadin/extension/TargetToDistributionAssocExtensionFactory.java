 ...
 */
public class TargetToDistributionAssocExtensionFactory extends BaseAssociationExtensionFactory<StatefulTargetObject, Distribution2TargetAssociation> {
    ...
    @Override
    protected Stream<Distribution2TargetAssociation> getAssocations(StatefulTargetObject target) {
